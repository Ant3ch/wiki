...
exports.default = polishData;
const jsdom_1 = require("jsdom");
async function polishData(html, selectedLetterOnLinks, letterPosition, finalPage, // final page parameter
pageType = "wikiPage") {
    ...
    anchors.forEach(a => {
        if (!a.getAttribute("href"))
            return;
        if (finalPage) {
            const finalHref = pageType === "dicoPage"
                ? `/dico/${encodeURIComponent(finalPage)}`
                : `/wiki/${encodeURIComponent(finalPage)}`;
        ...
        const newHref = pageType === "dicoPage"
